...
public class Ball : MonoBehaviour
{
    ...
    private Vector3 OffsetPos = new Vector3(0, 3.08f, -7.8f);
    ...
    void Start()
    {
        ...
        childBall = transform.Find("Pokeball");
        ...
        Debug.Log(temp);
        this.gameObject.GetComponent<Transform>().SetParent(FindObjectOfType<Canvas>().gameObject.transform);
        //this.GetComponent<FixedJoint>().connectedBody = cam.gameObject.GetComponentInChildren<Rigidbody>();
    ...
    void Update()
    {
        ...
        if (!isThrowing)
        {
            Vector3 camOffset = cam.transform.position - OffsetPos;
            this.transform.position = cam.transform.position - camOffset;
